...
import com.samuelseptiano.mvvmroom.data.repository.SearchRemoteMediator
...
class SearchPagerRepository @Inject constructor(
    private val database: NewsDatabase,
    private val newsRepository: NewsRepositoryImpl
) {

    fun getSearchPager(query: String): Flow<PagingData<News>> {
        ...
        return Pager(
            ...
            pagingSourceFactory = {
                database.searchNewsDao().getSearchPagingSource(query)
            }
        ).flow.map { pagingData ->
